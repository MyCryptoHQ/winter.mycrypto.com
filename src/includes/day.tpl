<section class="day__wrapper" id="@@id">
  ...
  <div class="day__modal" style="background-image: url('images/@@bg_img')">
    ...
    <div class="day__content">
      ...
      @@if ( twitter_desc != "" ) {
        <div class="day__share">
          <a class="day__twitter-link" target="_blank" rel="noopener" href="https://twitter.com/home?status=@@twitter_desc">
      ...
      @@if ( company_img != "" ) {
        <a href="@@company_url" class="company__section" target="_blank" rel="noopener">
          ...
          <div class="company__logo">
            <img class="company__img" src="images/@@company_img" height="20px" width="auto" />
          </div>
        </a>
      }
